...
public class PartyAllocator {
    ...
    public static class AllocatedParties {
        ...
        public AllocatedParties(String auctionAgent, String bank1, String bank2, String bank3, String centralBank, String csd, String issuer, String operator, String regulator) {
    ...
    public static AllocatedParties allocate(ManagedChannel channel) {
        ...
        final AllocatedParties allocatedParties = new AllocatedParties(
    ...
    private static String allocateParty(PartyManagementServiceGrpc.PartyManagementServiceBlockingStub stub, String party) {
        PartyManagementServiceOuterClass.AllocatePartyResponse response =
                stub.allocateParty(PartyManagementServiceOuterClass.AllocatePartyRequest.newBuilder()
